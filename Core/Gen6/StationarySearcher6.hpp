...
class StationarySearcher6 : public QObject
{
    Q_OBJECT
signals:
    void finished();
...
public:
    StationarySearcher6(const QDateTime &start, const QDateTime &end, u32 startFrame, u32 endFrame, bool ivCount,
        int ability, int synchNature, int gender, bool alwaysSynch, bool shinyLocked, const Profile6 &profile,
