...
ProfileEditor7::ProfileEditor7(QWidget *parent)
    : QDialog(parent)
...
ProfileEditor7::ProfileEditor7(u32 tick, u32 offset, QWidget *parent)
    : QDialog(parent)
    , ui(new Ui::ProfileEditor7)
{
    ui->setupUi(this);
...
void ProfileEditor7::accepted()
{
    ...
    fresh = Profile7(input, ui->textBoxProfileOffset->getUInt(), ui->textBoxProfileTick->getUInt(),
