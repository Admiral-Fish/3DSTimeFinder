 ...
 * Copyright (C) 2017-2021 by Admiral_Fish
 *
...
public:
    ...
    constexpr Date operator+(const Date &other) const
    {
        return Date(jd + other.jd);
    }
...
public:
    ...
    DateTime(u64 milliseconds);
    void addSeconds(int seconds);
    DateTime addSecs(int seconds);
    Date getDate() const;
    Time getTime() const;
    std::string toString() const;
    u64 toMSecsSinceEpoch() const;
