...
#include <Forms/Models/ProfileModel7.hpp>
#include <QMessageBox>
#include <QSettings>
...
void ProfileManager7::setupModels()
{
    ...
    model->addItems(ProfileLoader7::getProfiles());
...
void ProfileManager7::edit()
{
    ...
    {
        Profile7 profile = dialog->getNewProfile();
        ProfileLoader7::updateProfile(profile, dialog->getOriginal());
...
void ProfileManager7::remove()
{
    ...
    {
        ProfileLoader7::removeProfile(model->getItem(r));
        model->removeItem(r);
        emit updateProfiles();
    }
}
