...
ProfileEditor6::ProfileEditor6(QWidget *parent) : QDialog(parent), ui(new Ui::ProfileEditor6)
{
    ui->setupUi(this);
...
void ProfileEditor6::accepted()
{
    ...
    fresh = Profile6(input.toStdString(), ui->textBoxProfileSaveVariable->getUInt(), ui->textBoxProfileTimeVariable->getUInt(),
